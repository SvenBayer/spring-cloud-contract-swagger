...
"""{
  ...
  "name" : "name"
    ...
    def "should convert from swagger with min and max values to contract"() {
        given:
            File singleSwaggerYaml = new File(SwaggerContractConverterSpec.getResource("/swagger/numeric_exclusive_min_max_swagger.yml").toURI())
            Contract expectedContract = Contract.make {
                label("takeoff_coffee_bean_rocket")
                name("1_takeoff_POST")
                description("API endpoint to send a coffee rocket to a bean planet and returns the bean planet.")
...
"""{
  ...
  "name" : "name"
    ...
    def "should convert from swagger with json x-example to contract"() {
        given:
            File singleSwaggerYaml = new File(SwaggerContractConverterSpec.getResource("/swagger/json_xexample_param_swagger.yml").toURI())
            Contract expectedContract = Contract.make {
                label("takeoff_coffee_bean_rocket")
                name("1_takeoff_POST")
                description("API endpoint to send a coffee rocket to a bean planet and returns the bean planet.")
...
"""{ "asteroids" : [ { "shape" : "BEAN", "aliens" : [ { "heads" : [ "big ones" ] } ], "name" : "Beansteroid", "speed" : 250, "istransparent" : false } ], "size" : 1, "name" : "Beanlet" }""")
    ...
    def "should convert from swagger with json example to contract"() {
        given:
            File singleSwaggerYaml = new File(SwaggerContractConverterSpec.getResource("/swagger/json_example_param_no_ref_swagger.yml").toURI())
            Contract expectedContract = Contract.make {
                label("takeoff_coffee_bean_rocket")
                name("1_takeoff_POST")
                description("API endpoint to send a coffee rocket to a bean planet and returns the bean planet.")
...
"""{ "asteroids" : [ { "shape" : "BEAN", "aliens" : [ { "heads" : [ "big ones" ] } ], "name" : "Beansteroid", "speed" : 250, "istransparent" : false } ], "size" : 1, "name" : "Beanlet" }""")
    ...
    def "should convert from swagger with json x-example and no ref to contract"() {
        given:
            File singleSwaggerYaml = new File(SwaggerContractConverterSpec.getResource("/swagger/json_xexample_param_no_ref_swagger.yml").toURI())
            Contract expectedContract = Contract.make {
                label("takeoff_coffee_bean_rocket")
                name("1_takeoff_POST")
                description("API endpoint to send a coffee rocket to a bean planet and returns the bean planet.")
